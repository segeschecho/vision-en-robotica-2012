...
\hfill 17 de Julio de 2012

En este trabajo se prensenta un algoritmo de evansi\'on de obst\'aculos basado \'unicamente en visi\'on est\'ereo para la navegaci\'on aut\'onoma de un robot. El algoritmo de evasi\'on de obst\'aculos puede ser adapatado a cualquier dispositivo que cuente con una c\'amara est\'ereo, en particulas, se utiliz\'o como plataforma de prueba el robot \emph{exabot} []. Adem\'as debe ser eficiente dado que debe adaptarse a los recursos escasos con lo que cuenta una plataforma m\'ovil. 
 
Visi\'on est\'ereo es una herramienta muy usada en los \'ultimos a\~nos debido al bajo precio de las c\'amaras y a la gran cantidad de informaci\'on que brinda. Una de sus principales aplicaciones es la navegaci\'on aut\'onoma, ya que permite no solo construir mapas 3D del entorno si no que tambi\'en construir el mapa y simult\'anea conocer su localizaci\'on
